...
/** Generated Process for (Generate Production Batch Order from Project)
 *  @author ADempiere (generated) 
 *  @version Release 3.9.0
 */
public abstract class ProjectGenerateProductionBatchOrderAbstract extends SvrProcess {
	/** Process Value 	*/
	private static final String VALUE_FOR_PROCESS = "C_Project_GeneratePRO";
	/** Process Name 	*/
	private static final String NAME_FOR_PROCESS = "Generate Production Batch Order from Project";
	/** Process Id 	*/
	private static final int ID_FOR_PROCESS = 54146;
