 ...
 */
public class LocalPrinterTicketHandler extends POSTicketHandler {

	/**
	 * Default Constructor
	 * @param pos
	 */
	public LocalPrinterTicketHandler(CPOS pos) {
		super(pos);
	}
	...
	public void printTicket() {
		try {
			...
			//	Set Default POS
			MPOS pos = MPOS.get(getPOS().getCtx(), getPOS().getC_POS_ID());
			int localPrinterId = pos.get_ValueAsInt("DefaultPrinter_ID");
			if(localPrinterId > 0) {
				Env.setContext(getPOS().getCtx(), "#LocalPrinter_ID", localPrinterId);
			}
