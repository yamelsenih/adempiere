...
public class ReverseTheSalesTransaction extends ReverseTheSalesTransactionAbstract  {
    ...
    protected String doIt() throws Exception {
        ...
        sourceOrder.setDocStatus(DocAction.STATUS_Closed);
        sourceOrder.setDocAction(DocAction.ACTION_None);
        sourceOrder.saveEx();
        if(isDelivered) {
        	returnOrder.setDocStatus(DocAction.STATUS_Closed);
        	returnOrder.setDocAction(DocAction.ACTION_None);
        	returnOrder.saveEx();
        }
        return "@Ok@";
    }
