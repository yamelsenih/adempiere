...
/** Generated Process for (Create Inventory from Request)
 *  @author ADempiere (generated) 
 *  @version Release 3.9.2
 */
public abstract class InventoryCreateFromRequestAbstract extends SvrProcess {
	/** Process Value 	*/
	private static final String VALUE_FOR_PROCESS = "SBP_CreateInventoryFromRQ";
	/** Process Name 	*/
	private static final String NAME_FOR_PROCESS = "Create Inventory from Request";
	/** Process Id 	*/
