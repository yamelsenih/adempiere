...
/** Generated Process for (Payroll Process Report (Upload to External Storage))
 *  @author ADempiere (generated) 
 *  @version Release 3.9.0
 */
public abstract class EmployeePayrollReportExternalStorageAbstract extends SvrProcess {
	/** Process Value 	*/
	private static final String VALUE_FOR_PROCESS = "EmployeePayrollReportExternalStorage";
	/** Process Name 	*/
	private static final String NAME_FOR_PROCESS = "Payroll Process Report (Upload to External Storage)";
	/** Process Id 	*/
	private static final int ID_FOR_PROCESS = 1000016;
	...
	/**	 Getter Parameter Value for Payroll Process Report Template	*/
