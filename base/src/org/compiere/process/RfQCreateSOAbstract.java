...
/** Generated Process for (Create Sales Order)
 *  @author ADempiere (generated) 
 *  @version Release 3.9.1
 */
public abstract class RfQCreateSOAbstract extends SvrProcess {
	/** Process Value 	*/
	private static final String VALUE_FOR_PROCESS = "C_RfQ_CreateSO";
	/** Process Name 	*/
	private static final String NAME_FOR_PROCESS = "Create Sales Order";
	/** Process Id 	*/
	private static final int ID_FOR_PROCESS = 267;
