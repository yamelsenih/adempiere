 ...
 */
public abstract class CreateInvoiceFromServiceContractAbstract extends SvrProcess {
	/** Process Value 	*/
	private static final String VALUE_FOR_PROCESS = "CreateInvoiceFromServiceContract";
	/** Process Name 	*/
	private static final String NAME_FOR_PROCESS = "Generate Invoice from Service Contract";
	/** Process Id 	*/
	private static final int ID_FOR_PROCESS = 2000049;
