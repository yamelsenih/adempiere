...
public class X_S_ContractTax extends PO implements I_S_ContractTax, I_Persistent 
{
    ...
    {
      super (ctx, S_ContractTax_ID, trxName);
      /** if (S_ContractTax_ID == 0)
        {
			setS_ContractTax_ID (0);
        } */
    }

    /** Load Constructor */
    public X_S_ContractTax (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_S_ContractTax[")
