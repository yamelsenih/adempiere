...
// @#C_UOM_ID@
			...
			setLine (0);
// @SQL=SELECT COALESCE(MAX(Line),0)+10 AS DefaultValue FROM S_ContractLine WHERE S_Contract_ID=@S_Contract_ID@
...
// 0
    ...
    /** Load Constructor */
    public X_S_ContractLine (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_S_ContractLine[")
	...
	/** Month = N */
	public static final String FREQUENCYTYPE_Month = "N";
	/** Set Frequency Type.
		@param FrequencyType 
		Frequency of event
	  */
	...
	public com.eevolution.model.I_S_ContractLine getLink_ContractLine() throws RuntimeException
    {
		return (com.eevolution.model.I_S_ContractLine)MTable.get(getCtx(), com.eevolution.model.I_S_ContractLine.Table_Name)
			.getPO(getLink_ContractLine_ID(), get_TrxName());	}

	/** Set Linked Contract Line.
		@param Link_ContractLine_ID 
		This field links a customer contract line to the vendor contract line that is generated from it.
	  */
	public void setLink_ContractLine_ID (int Link_ContractLine_ID)
	{
		if (Link_ContractLine_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_Link_ContractLine_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_Link_ContractLine_ID, Integer.valueOf(Link_ContractLine_ID));
	}

	/** Get Linked Contract Line.
		@return This field links a customer contract line to the vendor contract line that is generated from it.
	  */
	public int getLink_ContractLine_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_Link_ContractLine_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	public com.eevolution.model.I_S_ContractLine getRef_ContractLine() throws RuntimeException
    {
		return (com.eevolution.model.I_S_ContractLine)MTable.get(getCtx(), com.eevolution.model.I_S_ContractLine.Table_Name)
	...
	public com.eevolution.model.I_S_Contract getS_Contract() throws RuntimeException
    {
		return (com.eevolution.model.I_S_Contract)MTable.get(getCtx(), com.eevolution.model.I_S_Contract.Table_Name)
	...
	/** Get Service ContractLine.
		@return Service ContractLine
	  */
	...
	public com.eevolution.model.I_S_ServiceType getS_ServiceType() throws RuntimeException
    {
		return (com.eevolution.model.I_S_ServiceType)MTable.get(getCtx(), com.eevolution.model.I_S_ServiceType.Table_Name)
	...
	public void setS_ServiceType_ID (int S_ServiceType_ID)
	{
		if (S_ServiceType_ID < 1) 
			set_Value (COLUMNNAME_S_ServiceType_ID, null);
		else 
			set_Value (COLUMNNAME_S_ServiceType_ID, Integer.valueOf(S_ServiceType_ID));
	}
