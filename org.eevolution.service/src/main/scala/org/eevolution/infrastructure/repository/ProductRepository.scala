...
/**
  ...
  */
trait ProductRepository extends ProductRepositoryComponet {

  final override object productRepository extends ProductRepositoryTrait {
    ...
    override def getByServiceTypeId(serviceTypeId: Integer): Option[Product] = {
