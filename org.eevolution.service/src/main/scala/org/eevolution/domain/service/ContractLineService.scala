...
import org.eevolution.domain.api.service.ContractLineServiceComponent
...
/**
  ...
  */
trait ContractLineService extends ContractLineServiceComponent {
  this: ContractLineRepositoryComponent =>
