...
/**
  * Invoice Line Domain Service contract to implement the business logic for Invoice Line Entity
  */
trait InvoiceLineServiceComponent {

  def invoiceLineService: InvoiceLineServiceTrait

  trait InvoiceLineServiceTrait extends ServiceComponent {
